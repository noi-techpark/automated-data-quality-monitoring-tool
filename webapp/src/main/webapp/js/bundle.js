"use strict";
(() => {
  // src/main/typescript/Loader.ts
  var Loader = class extends HTMLElement {
    constructor() {
      super();
  ...
  // src/main/typescript/api/api3.ts
  var API3 = class _API3 {
    ...
    static async list__catchsolve_noiodh__test_dataset_max_ts_vw(filter) {
      const resp = await _API3.call("catchsolve_noiodh.catchsolve_noiodh__test_dataset_max_ts_vw", filter);
      return resp;
    }
    static async list__catchsolve_noiodh__test_dataset_check_category_failed_recors_vw(filter) {
      const resp = await _API3.call("catchsolve_noiodh.test_dataset_check_category_failed_recors_vw", filter);
      return resp;
    }
    static async list__catchsolve_noiodh__test_dataset_check_category_check_name_failed_recors_vw(filter) {
      const resp = await _API3.call("catchsolve_noiodh.test_dataset_check_category_check_name_failed_recors_vw", filter);
      return resp;
    }
    static async list__catchsolve_noiodh__test_dataset_check_category_check_name_record_record_failed_vw(filter) {
      const resp = await _API3.call("catchsolve_noiodh.test_dataset_check_category_check_name_record_record_failed_vw", filter);
      return resp;
    }
    static async list__catchsolve_noiodh__test_dataset_record_check_failed(filter) {
      const resp = await _API3.call("catchsolve_noiodh.test_dataset_record_check_failed", filter);
      return resp;
    }
    static async list__catchsolve_noiodh__test_dataset_check_category_record_jsonpath_failed_vw(filter) {
      const resp = await _API3.call("catchsolve_noiodh.test_dataset_check_category_record_jsonpath_failed_vw", filter);
      return resp;
    }
    static async list__catchsolve_noiodh__test_dataset_history_vw(filter) {
      const resp = await _API3.call("catchsolve_noiodh.test_dataset_history_vw", filter);
      return resp;
    }
    // end crudl methods
  };

  // src/main/typescript/quality.ts
  function cs_cast(tc, x) {
    if (x === void 0)
  ...
  function cs_notnull(x) {
    if (x === null)
      throw new Error("unexpected null value");
    return x;
  }

  // src/main/typescript/MenuComponent.ts
  var MenuComponent = class extends HTMLElement {
    sroot;
    submenus;
    menuitemByName = {};
    menuready_promise;
  ...
  // src/main/typescript/LabelAndData.ts
  var LabelAndData = class extends HTMLElement {
    label;
    data;
    constructor() {
      super();
  ...
  // src/main/typescript/DatasetCardComponent.ts
  var DatasetCardComponent = class extends HTMLElement {
    dtitle;
    img;
    checkrecs;
    checkattr;
  ...
  // src/main/typescript/StandardDashboardsComponent.ts
  var StandardDashboardsComponent = class extends HTMLElement {
    sroot;
    boxContainer;
    boxes = [];
    titles = [];
    constructor() {
      ...
      this.sroot.innerHTML = `
			...
			<div class="ProjectsElement">
				...
				<div class="searchbar">
					<input> \u{1F50D} <span class="clearinput">\u2715</span>
				</div>
  ...
  // src/main/typescript/OpenCloseSection.ts
  var OpenCloseSection = class extends HTMLElement {
    content;
    open = true;
    openclose;
    label;
  ...
  // src/main/typescript/SectionRow.ts
  var SectionRow = class extends HTMLElement {
    label;
    constructor() {
      super();
      const sroot = this.attachShadow({ mode: "open" });
  ...
  // src/main/typescript/DatasetIssueCategoryComponent.ts
  var DatasetIssueCategoryComponent = class extends HTMLElement {
    template;
    connected_promise;
    ...
    async refresh(data) {
      ...
      API3.list__catchsolve_noiodh__test_dataset_check_category_check_name_failed_recors_vw({
        ...
        for (let i2 = 0; i2 < checks.length; i2++) {
          ...
          div.textContent = checks[i2].check_name;
  ...
  // src/main/typescript/DatasetIssuesDetail.ts
  var DatasetIssuesDetail = class extends HTMLElement {
    container;
    ...
    constructor() {
      ...
      this.issues.onclick = () => {
        ...
        if (this.last_session_start_ts != null && this.last_dataset_name != null && this.last_check_category != null && this.last_failed_records != null && this.last_tot_records != null)
    ...
    groupRecords(list) {
      ...
      for (let k = 0; k < list.length; k++) {
        ...
        prev_arr = prev_arr === void 0 ? [] : prev_arr;
  ...
  // src/main/typescript/DatasetIssuesByCategories.ts
  var DatasetIssuesByCategories = class extends HTMLElement {
    content;
    connected_promise;
    connected_func = (s) => null;
    connectedCallback() {
  ...
  function b64DecodeUnicode2(str) {
  ...
  function base64UrlDecode2(str) {
    ...
    try {
      return b64DecodeUnicode2(output);
    } catch (err) {
      return atob(output);
    }
  }
  ...
  // src/main/typescript/AuthComponent.ts
  var AuthComponent = class extends HTMLElement {
    sroot;
    keycloak;
    div_unauthenticated;
    div_authenticated;
    ...
    constructor() {
      ...
      this.keycloak = new keycloak_default({
  ...
  // src/main/typescript/MainComponent.ts
  var MainComponent = class extends HTMLElement {
    sroot;
    dashboards = null;
    changingSection;
    logo;
